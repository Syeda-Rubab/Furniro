    ...
    },
    {
      ...
      value: (
        <div className="flex gap-[23px]">
          <div>
            <Image src="/images/facebook.png" alt="facebook" width={2} height={2} />
          </div>
          <div>
            <Image src="/images/linkedin.png" alt="linkedin" width={2} height={2} />
          </div>
          <div>
            <Image src="/images/twitter.png" alt="twitter" height={2} width={2} />
          </div>
        </div>
      ),
    },
